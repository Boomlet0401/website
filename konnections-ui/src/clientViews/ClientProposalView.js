...
import YoutubeBlock from './components/social-rows/YoutubeBlock';
import BlogBlock from './components/social-rows/BlogBlock';
import FacebookBlock from './components/social-rows/FacebookBlock';
import InstagramBlock from './components/social-rows/InstagramBlock';
import LinkedinBlock from './components/social-rows/LinkedinBlock';
import TiktokBlock from './components/social-rows/TiktokBlock';
import TwitterBlock from './components/social-rows/TwitterBlock';

class ClientProposalView extends Component {
    ...
    render() {
        return (
            <div className="main_bock">
                ...
                <div className="main_container bg-light" style={{ maxWidth: 1400, width: "100%" }}>

...
import sicialIcon from '../../assets/icons/Instagram.svg';
...
export default class InstagramBlock extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            detailRows: [],
            Columns: this.props.instagramColumns, // change this with correct Social
            title: "Instagram", // Chnage this with correcr Social
        }
    }
    ...
    render() {
        ...
        const social_id = "instagram_row_";
            ...
            <div>
                ...
                <div className={'influencer_details_header_block'}>
                    ...
                    <div className={'d-flex align-items-center'} >
                        ...
                        <span
                            onClick={() => {
                                let confirm = window.confirm("Are you sure? You want to remove all instagram rows");
                                if (confirm) {

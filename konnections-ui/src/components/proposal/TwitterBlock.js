...
import sicialIcon from '../../assets/icons/twitter.svg';
...
export default class TwitterBlock extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            detailRows: [],
            Columns: this.props.twitterColumns, // Chnage this with correcr Social
            title: "Twitter", // Chnage this with correcr Social
        }
    }
    ...
    render() {
        ...
        const social_id = "twitter_row_"; // Chnage this with correcr Social
            ...
            <div>
                ...
                <div className={'influencer_details_header_block'}>
                    ...
                    <div className={'d-flex align-items-center'} >
                        ...
                        <span
                            onClick={() => {
                                let confirm = window.confirm("Are you sure? You want to remove all twitter rows");
                                if (confirm) {

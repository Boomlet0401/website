...
import sicialIcon from '../../assets/icons/linkedin.svg';
import edit from '../../assets/icons/edit-24px.svg';
import save from '../../assets/icons/save-24px.svg';
import deleteimg from '../../assets/icons/delete24.svg';

export default class LinkedinBlock extends Component {

    constructor(props) {
        super(props);
        this.state = {
            detailRows: [],
            Columns: this.props.linkedinColumns, // Chnage this with correcr Social
            title: "Linkedin", // Chnage this with correcr Social
        }
    }
    ...
    render() {
        ...
        const social_id = "linkedin_row_"; // Chnage this with correcr Social
            ...
            <div>
                ...
                <div className={'influencer_details_header_block'}>
                    ...
                    <div className={'d-flex align-items-center'} >
                        ...
                        <span
                            onClick={() => {
                                let confirm = window.confirm("Are you sure? You want to remove all linkedin rows");
                                if (confirm) {
                            ...
                            <tr>
                                ...
                                <th>Language</th>
                                {
                                    this.state.Columns.map((item, i) => {
                                        ...
                                        if (item.checked) {
                                            return (<th key={i}>{item.title} <span style={{ display: 'block', fontSize: 10 }}>{item.subTitle}</span></th>);
                                        } else {
                                            return null;
                                        }
                                    ...
                                    return (
                                        <React.Fragment key={index}>
                                            <tr id={social_id + "inf_detail_row_" + influencer.id + "_" + index}>
                                                ...
                                                <td className={''}>
                                                    <div style={{ width: 60 }}>
                                                        <img data-id={social_id + "inf_detail_row_" + influencer.id + "_" + index} className={"edit_influencer_detail_row"} alt="" style={{ width: 20 }} src={edit} />
                                                        <span onClick={() => {
                                            ...
                                            <tr className={'d-none'} id={social_id + "inf_detail_row_" + influencer.id + "_" + index + "_edit"}>
                                                ...
                                                <td className={''}>
                                                    <div style={{ width: 60 }}>
                                                        <img data-id={social_id + "inf_detail_row_" + influencer.id + "_" + index} className={"edit_influencer_detail_row"} alt="" style={{ width: 15 }} src={save} />
                                                    </div>
                                                </td>
                                            </tr>
                                        </React.Fragment>

...
import sicialIcon from '../../assets/icons/facebook.svg';
...
export default class FacebookBlock extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            detailRows: [],
            Columns: this.props.facebookColumns, // Chnage this with correcr Social
            title: "Facebook", // Chnage this with correcr Social
        }
    }
    ...
    render() {
        ...
        const social_id = "facebook_row_"; // Chnage this with correcr Social
            ...
            <div>
                ...
                <div className={'influencer_details_header_block'}>
                    ...
                    <div className={'d-flex align-items-center'} >
                        ...
                        <span
                            onClick={() => {
                                let confirm = window.confirm("Are you sure? You want to remove all facebook rows");
                                if (confirm) {
